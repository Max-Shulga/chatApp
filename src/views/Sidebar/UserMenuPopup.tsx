...
function UserMenuPopup({
  ...
  return (
    <div ref={ref} className={`${className} w-full px-4 rounded-2`}>
      <StyledContainer className='className="flex flex-col gap-0 rounded-2 border border-gray-200 shadow-drop w-full '>
